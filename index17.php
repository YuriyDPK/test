...
<body>
    ...
    ?>
        <h1>Проект</h1>
            <table>
                <tr>
                    <td>структура, состоящая из процессов, работ и задач, включающих в себя разработку, эксплуатацию и сопровождение программного продукта, охватывающая жизнь системы от установления требований к ней до прекращения ее использования.</td>
                    <td><input type="radio" name="v1" ></td>
                    
                </tr>
                <tr>
                    <td>совокупность содержащейся в базах данных информации и обеспечивающих ее обработку информационных технологий и технических средств</td>
                    <td><input type="radio" name="v1"></td>
                </tr>
                <tr>
                    <td>попытка действий с определенными начальными и конечными сроками, предпринимаемая для создания продукта или услуги в соответствии с заданными ресурсами или требованиями</td>
