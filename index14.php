...
<body>
    ...
    ?>
        <h1>Отказоустойчивость программного продукта</h1>
            <table>
                <tr>
                    <td>окумент, используемый заказчиком в качестве средства для описания и определения задач, выполняемых при реализации договора</td>
                    <td><input type="radio" name="v1" ></td>
                    
                </tr>
                <tr>
                    <td>cвойство ПП, заключающееся в возможности коррекции отдельных ошибок при сохранении возможности продолжения выполнения программы</td>
                    <td><input type="radio" name="v1" value='verno'></td>
                </tr>
                <tr>
                    <td>свойство объекта существовать во времени и/или в пространстве</td>
                    <td> <input type="radio" name="v1"></td>
                </tr>
            </table>
            <?php
