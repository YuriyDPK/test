...
<body>
    ...
    ?>
        <h1>Системный подход</h1>
            <table>
                <tr>
                    <td>процесс рассмотрения любой системы в качестве совокупности взаимосвязанных элементов</td>
                ...
                <tr>
                    <td>упорядоченная совокупность методологий и средств создания или модернизации информационных систем. Компонентами проектирования могут являться: подсистемы, модули, процессы, системы</td>
                    <td> <input type="radio" name="v1"></td>
                </tr>
            </table>
            <?php
