...
<body>
<audio src="icant.mp3" autoplay></audio>
    <div class="genius"></div>
    
    <?php 
    echo "<form method='POST' action='check.php?id=$id'>";
    ?>
        <h1>Жизненный цикл информационных системы</h1>
            <table>
                <tr>
                    <td>развитие рассматриваемой системы во времени, начиная от замысла и кончая списанием</td>
                    <td><input type="radio" name="v1" value='verno'></td>
                    
                </tr>
                <tr>
                    <td>свойство ПП, заключающееся в возможности коррекции отдельных ошибок при сохранении возможности продолжения выполнения программы</td>
                    <td><input type="radio" name="v1" ></td>
                </tr>
                <tr>
                    <td>локализация и исправление ошибок</td>
                    <td> <input type="radio" name="v1"></td>
                </tr>
            </table>
            <?php
