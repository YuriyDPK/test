...
<body>
<audio src="misha.mp3" autoplay></audio>
    <div class="genius"></div>
    
    <?php 
    echo "<form method='POST' action='check.php?id=$id'>";
    ?>
    <h1>Вы прошли тест, можете начать заного</h1>
        <a href="ref.php" style='background: red; text-decoration: none; color: white; margin-top: 3em; padding: 1em;'>Заного</a>
            <?php
                $anw = $_SESSION['error'];
