...
<body>
<audio src="bomb.mp3" autoplay></audio>
    ...
    ?>
        <h1>Верификация</h1>
            <table>
                <tr>
                    <td>определенные способы представления элементов информационной системы</td>
                    <td><input type="radio" name="v1" ></td>
                    
                </tr>
                <tr>
                    <td>процессы, методы поиска, сбора, хранения, обработки, предоставления, распространения информации и способы осуществления таких процессов и методов</td>
                    <td><input type="radio" name="v1" ></td>
                </tr>
                <tr>
                    <td>подтверждение (на основе объективных свидетельств) того, что конкретные требования полностью выполнены.</td>
