...
<body>
<audio src="nenado.mp3" autoplay></audio>
    ...
    ?>
        <h1>Бизнес-процесс</h1>
            <table>
                ...
                <tr>
                    <td>это цепочка взаимосвязанных действий, направленных на создание товарной продукции или услуги</td>
                    <td><input type="radio" name="v1" value='verno'></td>
                </tr>
                <tr>
                    <td>это концепция, определяющая модель, структуру, выполняемые функции и взаимосвязь компонентов информационной системы</td>
                    <td> <input type="radio" name="v1"></td>
                </tr>
            </table>
            <?php
