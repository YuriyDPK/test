...
<body>
    ...
    ?>
        <h1>Процесс</h1>
            <table>
                <tr>
                    <td>четкое закрепление за каждой структурной единицей набора функций</td>
                    <td><input type="radio" name="v1" ></td>
                    
                </tr>
                <tr>
                    <td>совокупность взаимосвязанных или взаимодействующих видов деятельности, преобразующих входы и выходы.</td>
                    <td><input type="radio" name="v1" value='verno'></td>
                </tr>
                <tr>
                    <td>применение методов управления процессами планирования, анализа, дизайна, создания, внедрения и эксплуатации информационной системы организации для достижения ее целей</td>
                    <td> <input type="radio" name="v1"></td>
                </tr>
            </table>
            <?php
