    ...
    ?>
        <h1>Тестирование</h1>
            <table>
                ...
                <tr>
                    <td>выполнение программы в целях обнаружения ошибок</td>
                    <td><input type="radio" name="v1" value='verno'></td>
                    
                </tr>
                <tr>
                    <td>концепция, определяющая модель, структуру, выполняемые функции и взаимосвязь компонентов информационной системы</td>
                    <td> <input type="radio" name="v1"></td>
                </tr>
            </table>
            <?php
